              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    PriceWidget(price: bookingPackage!.price.validate(), color: textPrimaryColorGlobal).flexible(),
                  ],
                ),
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          16.width,
                          PriceWidget(price: bookingDetail.finalTotalTax.validate(), color: Colors.red),
                        ],
                      ),
                    ],
                  ),
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          if (bookingDetail.isFixedService)
                            ...
                            PriceWidget(price: bookingDetail.finalTotalServicePrice.validate(), color: textPrimaryColorGlobal),
                        ],
                      ),
                      16.height,
                    ],
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          PriceWidget(price: bookingDetail.finalCouponDiscountAmount.validate(), color: Colors.green, isDiscountedPrice: true),
                        ],
                      ),
                      16.height,
                    ],
                          ...
                          Text.rich(
                            TextSpan(
                              children: [
                                ...
                                TextSpan(
                                  text: " (${serviceDetail.advancePaymentPercentage.validate()}%)  ",
                                  style: boldTextStyle(color: Colors.green),
                                ),
                              ],
                            ),
